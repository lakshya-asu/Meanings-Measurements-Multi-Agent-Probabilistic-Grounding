...
MSP_POINT_JSON="/root/graph_eqa/src/outputs_benchmark_point/grapheqa_spatial_gemini_habitat_benchmark/gemini_images_True.json"
MSP_OBJECT_JSON="/root/graph_eqa/src/outputs_benchmark_object/grapheqa_spatial_gemini_habitat_benchmark/gemini_images_True.json"
