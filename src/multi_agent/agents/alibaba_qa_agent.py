...
class AlibabaQaAgent:
    ...
    def process(self, blackboard: Blackboard) -> Dict[str, Any]:
        ...
        try:
            ...
            blackboard.append_event("QA(Alibaba)", out["action_type"], out, "PASS")
            return out
        except Exception as e:
            error_msg = f"Failed to infer MCQ QA (Alibaba): {e}"
            blackboard.append_event("QA(Alibaba)", "Error", error_msg, "FAIL")
