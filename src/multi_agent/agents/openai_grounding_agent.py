...
class OpenAIGroundingAgent:
    ...
    def process(self, blackboard: Blackboard, orchestrator_output: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            blackboard.append_event("Grounding(OpenAI)", "MatchObjects", parsed, "PASS")
            return parsed
        except Exception as e:
            error_msg = f"Visual grounding failed (OpenAI): {e}"
            blackboard.append_event("Grounding(OpenAI)", "Error", error_msg, "FAIL")
